...
class PengaturanPemasokView extends GetView<PengaturanPemasokController> {
  PengaturanPemasokView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Penjualan/Pengaturan pemasok',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Pengaturan pemasok Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
