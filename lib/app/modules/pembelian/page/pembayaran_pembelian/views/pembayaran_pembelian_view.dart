...
class PembayaranPembelianView extends GetView<PembayaranPembelianController> {
  PembayaranPembelianView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Penjualan/Pembayaran pembelian',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Pembayaran pembelian Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
