...
class PenerimaanBarangView extends GetView<PenerimaanBarangController> {
  PenerimaanBarangView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Penjualan/Faktur pembelian',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Faktur pembelian Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
