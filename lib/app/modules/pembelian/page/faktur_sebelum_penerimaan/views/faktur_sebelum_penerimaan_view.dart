...
class FakturSebelumPenerimaanView
    extends GetView<FakturSebelumPenerimaanController> {
  FakturSebelumPenerimaanView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Penjualan/Faktur sebelum penerimaan',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Faktur sebelum penerimaan Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
