...
class PesananPembelianView extends GetView<PesananPembelianController> {
  PesananPembelianView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Penjualan/Pesanan pembelian',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Pesanan pembelian Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
