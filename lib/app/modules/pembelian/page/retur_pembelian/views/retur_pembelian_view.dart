...
class ReturPembelianView extends GetView<ReturPembelianController> {
  ReturPembelianView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Penjualan/Retur pembelian',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Retur pembelian Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
