...
class PenyesuaianPersediaanView
    extends GetView<PenyesuaianPersediaanController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Persediaan/Penyesuaian Persediaan',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Penyesuaian Persediaan Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
