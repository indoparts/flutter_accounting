...
import 'components/persediaanpage_view.dart';

class PersediaanView extends GetView<PersediaanController> {
  PersediaanView({Key? key}) : super(key: key);
