...
class PengaturanPenggunaUmumView
    extends GetView<PengaturanPenggunaUmumController> {
  PengaturanPenggunaUmumView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Umum/Pengaturan Pengguna',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Pengaturan Pengguna Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
