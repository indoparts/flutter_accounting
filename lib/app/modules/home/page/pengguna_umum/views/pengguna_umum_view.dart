...
import 'components/pengguna_umum_page_view.dart';

class PenggunaUmumView extends GetView<PenggunaUmumController> {
  PenggunaUmumView({Key? key}) : super(key: key);
