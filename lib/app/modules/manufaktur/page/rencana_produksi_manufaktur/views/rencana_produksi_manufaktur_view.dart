...
class RencanaProduksiManufakturView
    extends GetView<RencanaProduksiManufakturController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Manufaktur/Rencana produksi',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Rencana Produksi Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
