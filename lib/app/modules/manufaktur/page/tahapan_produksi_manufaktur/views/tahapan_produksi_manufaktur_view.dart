...
class TahapanProduksiManufakturView
    extends GetView<TahapanProduksiManufakturController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Manufaktur/Tahapan produksi',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Tahapan Produksi Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
