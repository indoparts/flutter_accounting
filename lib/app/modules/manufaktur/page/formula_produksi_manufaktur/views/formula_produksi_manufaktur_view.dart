...
class FormulaProduksiManufakturView
    extends GetView<FormulaProduksiManufakturController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Manufaktur/Formula produksi',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Formula Produksi Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
