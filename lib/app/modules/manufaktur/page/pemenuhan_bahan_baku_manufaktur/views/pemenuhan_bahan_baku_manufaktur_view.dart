...
class PemenuhanBahanBakuManufakturView
    extends GetView<PemenuhanBahanBakuManufakturController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Manufaktur/Pemenuhan bahan baku produksi',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Pemenuhan Bahan Baku Produksi Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
