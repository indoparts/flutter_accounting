...
class BiayaStandarProduksiManufakturView
    extends GetView<BiayaStandarProduksiManufakturController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Manufaktur/Biaya standar produksi',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Biaya Standar Produksi Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
