...
import 'components/kasbankpage_view.dart';

class ManufakturView extends GetView<ManufakturController> {
  ManufakturView({Key? key}) : super(key: key);
