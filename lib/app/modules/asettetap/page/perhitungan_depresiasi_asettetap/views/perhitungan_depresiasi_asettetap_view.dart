...
class PerhitunganDepresiasiAsettetapView
    extends GetView<PerhitunganDepresiasiAsettetapController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Aset Tetap/Perhitungan Depresiasi',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Perhitungan Depresiasi Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
