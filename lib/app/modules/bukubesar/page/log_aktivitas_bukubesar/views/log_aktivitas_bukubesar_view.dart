...
class LogAktivitasBukubesarView
    extends GetView<LogAktivitasBukubesarController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: const PreferredSize(
            ...
            child: AppbarView(
              title: 'Buku besar/Log Aktivitas Jurnal',
            )),
                  ...
                  Expanded(
                    ...
                    child: SafeArea(
                      ...
                      child: Column(
                        children: const [
                          HeaderView(
                            title: 'Log Aktivitas Jurnal Overview',
                          ),
                          // content here....
                          // -------------------
                          // content here....
