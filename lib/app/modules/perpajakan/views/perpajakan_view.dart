...
import 'components/perpajakanpage_view.dart';

class PerpajakanView extends GetView<PerpajakanController> {
  PerpajakanView({Key? key}) : super(key: key);
